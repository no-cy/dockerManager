...
import com.example.dockermanager.application.auth.service.SocialLoginServiceFactory;
...
public class SocialLoginController {
    ...
    public ResponseDto<UserLoginDto>socialLogin(@PathVariable String provider, @RequestParam String code) {
        ...
        return ResponseDto.of(ResponseCode.LOGIN_SUCCESS.getHttpStatus(), ResponseCode.LOGIN_SUCCESS.getMessage(), socialLoginService.login(code));
    }
}
